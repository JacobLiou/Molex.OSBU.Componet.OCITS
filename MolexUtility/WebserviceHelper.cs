...
namespace MolexUtility
{
    public class WebServiceHelper
    {
        ...
        public static string LoadByHTTP(string strAddress)
        {
        ...
        public static bool GetNodeContentByName(string xmlStr, string strElementName, string[] strNodeName, out string[] strNodeContent, out string errMsg)
        {
